...
public record ProfileRequest(
        ...
        @Schema(description = "사용자의 닉네임", example = "팽이")
        String nickname,
        ...
        @NotBlank(message = "공개여부는 비워둘 수 없습니다.")
        @Schema(description = "계정 공개여부", example = "PUBLIC")
        Visibility visibility,

        @Schema(description = "사용자 프로필 이미지", example = "profile.jpg")
