...
public record ProfileResponse(
        ...
        @Schema(description = "한 줄 소개", example = "한줄소개")
        String bio,

        @Schema(description = "이메일", example = "juwon@gmail.com")
        String email,

        @Schema(description = "닉네임", example = "팽이")
        String nickname,

        @Schema(description = "Clokey ID", example = "juwon")
        String clokeyId,
        ...
        @Schema(description = "계정 공개 여부", example = "PUBLIC")
